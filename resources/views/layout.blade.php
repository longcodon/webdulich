                   ...
                   <div class="col-md-12 col-xs-12 top-5">
                       ...
                       <div class="cl-bnt fl">
                           <div class="banner-top">
                               <a href="{{ url('/') }}"><img alt="du lịch"
                                       src="{{ asset('frontend/images/banner-30-04.jpg') }}" alt="banner top"></a>
                           </div>
                       </div>
       ...
       <div class="slider-wrapper theme-default">
           <div id="slider-master" class="nivoSlider">
               <a href="#"><img src="{{ asset('frontend/images/phu-quoc-hon-mong-tay-vietnam-travel.jpg') }}"
                       ...
                       alt="aa" title="" /></a>
               <a href="#"><img src="{{ asset('frontend/images/thuong-ve-mien-trung-30-4-he-2022.png') }}"
                       data-thumb="{{ asset('frontend/images/thuong-ve-mien-trung-30-4-he-2022.png') }}"
                       alt="aa" title="" /></a>
               <a href="#"><img src="{{ asset('frontend/images/du_lich_he_2022-min.png') }}"
                       data-thumb="{{ asset('frontend/images/du_lich_he_2022-min.png') }}" alt="aa"
                       title="" /></a>
