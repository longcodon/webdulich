                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12 bx-title-lst-tour text-center">
                            <div class="w100 fl title-tour1">
                                <h2 style="color: #ffc700;font-size: 30px;"><img src="#" alt="icon"
                        ...
                        <div class="col-md-12 col-xs-12 bx-content-lst-tour">
                            ...
                            <div class="row">
                                @foreach ($tours as $key => $tour)
                                    @if ($tour->category->category_parent == $cate_parent->id)
                                                ...
                                                <div class="clearfix box-wap-imgpr">
                                                    <a href="{{ route('chi-tiet-tour', [$tour->slug]) }}">
                                                        <img src="{{ asset('uploads/tours/' . $tour->image) }}"
                                                            class="img-default" alt="tour" style="margin-bottom: 6px;">

                                                    </a>
                                                </div>
                                                <div class="clear"></div>
                                                <h4><a
                                                        href="{{ route('chi-tiet-tour', [$tour->slug]) }}">{{ $tour->title }}</a>
                                                </h4>
                                                <div class="clear"></div>
